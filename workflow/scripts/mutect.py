...
__author__ = "Omid Gholamalamdari"
__copyright__ = "Copyright 2022, Omid Gholamalamdari"
...
with tempfile.TemporaryDirectory() as tmpdir:
    shell(
        ...
        " --input {snakemake.input.tumor_bam}"  # Path to input mapping file
        " --input {snakemake.input.normal_bam}"
        " --reference {snakemake.input.fasta}"
        " --normal-sample {snakemake.params.normal_name}"  # Path to reference fasta file
